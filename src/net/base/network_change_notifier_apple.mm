...
#if BUILDFLAG(IS_IOS)
  // Network.framework's path monitor was introduced in iOS 12. Keep using
  // SCNetworkReachability on iOS 11 instead of weak-linking and accidentally
  // calling an unavailable entry point.
  if (!@available(iOS 12.0, *)) {
    return false;
  }
#endif
