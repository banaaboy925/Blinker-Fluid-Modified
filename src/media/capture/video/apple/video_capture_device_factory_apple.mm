...
void API_AVAILABLE(macos(14.0), ios(17.0)) ListAvailableCaptureDevices() {
  NSArray* deviceTypes = @[
...
// TODO(crbug.com/436126054) remove these functions after issue is resolved.
void API_AVAILABLE(macos(14.0), ios(17.0)) ListAvailableCaptureDevicesNoMic() {
  NSArray* deviceTypes = @[
    AVCaptureDeviceTypeBuiltInWideAngleCamera,
    AVCaptureDeviceTypeContinuityCamera, AVCaptureDeviceTypeExternal
  ];
...
// TODO(crbug.com/436126054) remove these functions after issue is resolved.
void API_AVAILABLE(macos(14.0), ios(17.0))
